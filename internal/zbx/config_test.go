...
func TestParseZabbixConfig_Defaults(t *testing.T) {
	...
	require.ElementsMatch(t, []string{zbxpkg.HISTORY, zbxpkg.TREND, zbxpkg.EVENT}, conf.ExportTypes)
...
`
	...
	require.ElementsMatch(t, []string{zbxpkg.HISTORY, zbxpkg.TREND}, conf.ExportTypes)
